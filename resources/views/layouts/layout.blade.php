...
<head>
    ...
    <meta name="keywords" content="Collège Maisonneuve, étudiants, réseau social">
    ...
    <div class="container">
      <div class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4">
        <div class="col-md-4 d-flex align-items-center">
          <span class="mb-3 mb-md-0 text-body-secondary">&copy; 2023 Collège de Maisonneuve</span>
        </div>
